            ...
            <div class="collapse navbar-collapse" id="navbarTop">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="#"> <i class="fa fa-phone"></i> Call us: <?= $mercado->tx_telefone ?> </a>
                    </li>
                </ul>
                <ul class="navbar-nav">
                ...
                <div class="col-lg-6-24 col-sm-7 col-8  order-2  order-lg-3">
                    <div class="d-flex justify-content-end">
                        <div class="widget-header">
                            <small class="title text-center text-white badge badge-primary"><?= (($this->session->userdata() !== null)) ? 'Bem vindo <br>' . $this->session->userdata('nome') : 'Welcome guest! '; ?></small>
                            <?= (($this->session->userdata() !== null)) ?  '' :'<div> <a href="#">Sign in</a> <span class="dark-transp"> | </span>
