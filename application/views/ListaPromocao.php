                ...
                <div class="card-body">
                    <div class="table-responsive shadow">
                        <div class="text-center text-white">
                            <a href="<?= $this->config->base_url() ?>Promocao/Cadastrar" class="btn btn-outline-info">Cadastrar</a>
                        </div>
                        <table class="table table-hover text-center mb-0">
                            ...
                            <tbody>
                                ...
                                if (count($promocoes) > 0) {
                                    ...
                                    echo '<tr><td class"align-middle" width="100%" colspan="9">Não há promoções registrados</td></tr>';
                                }
                                ?>
                            </tbody>
                        </table>
