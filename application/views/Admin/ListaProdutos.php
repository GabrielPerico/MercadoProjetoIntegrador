                            ...
                            <tbody>
                                ...
                                if (count($produtos) > 0) {
                                    ...
                                    foreach ($produtos as $p) {
                                        ...
                                        echo '<a data-toggle="tooltip" title="Alterar" class="btn btn-outline-secondary mr-3" href="' . $this->config->base_url() . 'Admin/Imagem/Produto/' . $p->id_produto . '"><i class="far fa-images"></i></a>';
