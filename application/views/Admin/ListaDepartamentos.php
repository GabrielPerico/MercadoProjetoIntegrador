                ...
                <div class="card-body">
                    <div class="table-responsive shadow">
                        <div class="text-center text-white">
                            <a href="<?= $this->config->base_url() ?>Admin/Departamento/Cadastrar" class="btn btn-outline-info">Cadastrar</a>
                        </div>
                        <hr>
                                ...
                                if (count($departamentos) > 0) {
                                    ...
                                    foreach ($departamentos as $d) {
                                        ...
                                        if($d->num_categorias > 0){
                                            echo '<span class="d-inline-block mr-3" tabindex="0" data-toggle="tooltip" title="Há categorias cadastrados nesse departamento!"><a class="disabled btn btn-outline-danger" href=""><i class="fas fa-times-circle"></i></a></span>';
                                        }else{
