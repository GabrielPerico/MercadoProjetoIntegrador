                ...
                <div class="card-body">
                    <div class="table-responsive shadow">
                        <div class="text-center text-white">
                            <a href="<?= $this->config->base_url() ?>Admin/Promocao/CadastrarProduto/<?= $id ?>" class="btn btn-outline-info">Cadastrar</a>
                        </div>
                            ...
                            <tbody>
                                ...
                                if (count($produtos) > 0) {
                                    foreach ($produtos as $p) {
                                        ...
                                        echo '<a data-toggle="tooltip" title="Deletar" class="btn btn-outline-danger mr-3" href="' . $this->config->base_url() . 'Admin/Promocao/DeletarProduto/' . $id . '/' . $p->id_produto . '"><i class="fas fa-times-circle"></i></a>';
                                        echo '</td>';
                                        echo '</tr>';
                                    }
                                } else {
                                    echo '<tr><td class"align-middle" width="100%" colspan="4">Não há produto registrados nesta promoção</td></tr>';
                                }
                                ?>
                            </tbody>
                        </table>
