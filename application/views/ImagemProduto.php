                            ...
                            <tbody>
                                ...
                                if (count($imagens) > 0) {
                                    ...
                                    foreach ($imagens as $i) {
                                        ...
                                        echo '<a data-toggle="tooltip" title="Deletar" class="btn btn-outline-danger mr-3" href="' . $this->config->base_url() . 'Produtos/Deletar/' . $i->ref_produto . '"><i class="fas fa-times-circle"></i></a>';
                                        echo '</td>';
                                        echo '</tr>';
                                    }
                                } else {
